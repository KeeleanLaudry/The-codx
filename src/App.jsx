...
function App() {
  ...
  // auto hide loader
  useEffect(() => {
    // Only show loader on first visit, not every refresh
    const hasVisited = sessionStorage.getItem("visited");

    if (hasVisited) {
      setLoading(false); // skip loader on refresh/direct URL
      return;
    }
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route
              ...
              element={<DigitalBrandingSection />}
            />
            ...
            <Route
              ...
              element={<Videoproductionsection />}
            />
